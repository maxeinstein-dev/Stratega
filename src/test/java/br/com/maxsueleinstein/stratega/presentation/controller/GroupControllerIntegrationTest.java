...
class GroupControllerIntegrationTest {
    ...
    void shouldCreateGroupAddExpenseAndGetBalances() throws Exception {
        ...
        br.com.maxsueleinstein.stratega.application.dto.GroupResponse group = objectMapper.readValue(createResponseJson, br.com.maxsueleinstein.stratega.application.dto.GroupResponse.class);
        UUID groupId = group.id();
        UUID aliceId = group.members().get(0).name().equals("Alice") ? group.members().get(0).id() : group.members().get(1).id();
        UUID bobId = group.members().get(0).name().equals("Bob") ? group.members().get(0).id() : group.members().get(1).id();
